...
Om2m.prototype.createDescriptorInst = function (appName, dataName, category, value, callback) {
    var path = '/~/' + this.type + '/' + this.name + '/' + appName + '/' + dataName,
        options = this._getOptions('POST', path, { 'Content-Type': 'application/xml;ty=4' }),
        body = '<m2m:cin xmlns:m2m="http://www.onem2m.org/xml/protocols">' +
                    '<cnf>message</cnf>' +
    ...
    for (var idx in value) {
        body += '&lt;op name=&quot;' + value[idx] + '&quot; href=&quot;/mn-cse/mn-name/' + appName + '?op=' + value[idx] + '&quot; is=&quot;execute&quot;/&gt;';
    }
